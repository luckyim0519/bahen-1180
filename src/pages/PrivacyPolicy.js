...
// privacy policy auto generated from https://urbansharing.com/privacy
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        decided to use our Service, the Website Name website.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at this website unless
      ...
      <p>
        ...
        but not limited to your name and facebook profile picture. The
        information is not stored on any server of any kind and is only
        temporarily stored on your own device.
      </p>
      ...
      <p>We employ Google Cloud Service Firebase to run this web application</p>
      ...
      <p>
        ...
        13. Please contact us if you have any valid concerns.
      </p>
